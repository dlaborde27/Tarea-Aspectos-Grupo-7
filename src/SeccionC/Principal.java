...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Situacion: una miniempresa con una sola impresora y Fax, todos deben utilizar el mismo equipo de trabajo ya que solo 
		//existe uno de cada uno osea, en pocas palabras, en el programa se utilizará LA MISMA INSTANCIA, asi se ahorrarian recursos
		//y sería una buena implementacion
